...
public class Canvas extends JComponent {
    ...
    private int sizeX = DefaultBoard.rowsConst;
    private int sizeY = DefaultBoard.columnsConst;
    private int maximumX = DefaultBoard.rowsConst;
    private int maximumY = DefaultBoard.columnsConst;
